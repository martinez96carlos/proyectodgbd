...
create table USERS (
   ...
   CITY_ID              INT4                 null,
   ROLE_ID              INT4                 null,
   USER_FIRST_NAME      VARCHAR(40)          null,
   USER_SECOND_NAME     VARCHAR(40)          null,
   USER_FIRST_LASTNAME  VARCHAR(40)          null,
   USER_SECOND_LASTNAME VARCHAR(40)          null,
   USER_NUMBER_ID       VARCHAR(20)          null,
...
alter table ORDERS
   add constraint FK_ORDERS_REFERENCE_USERS foreign key (ORDER_GENERATOR_ID)
