...
create table ORDERS (
   ...
   ORDER_IMAGE_URL      VARCHAR(50)          not null,
...
create table SOLIDS (
   ...
   SOLID_NAME           VARCHAR(20)          not null,
...
create table SOLID_TYPE (
   ...
   SOLID_TYPE_NAME      VARCHAR(20)          not null,
...
alter table USERS
   add constraint FK_USERS_REFERENCE_ROLES foreign key (ID_ROLE)
